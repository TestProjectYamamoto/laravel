...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            ...
            <hr>
            <div class="card">
                <form method="POST" action="{{ route('commentUpdate') }}">
                    @csrf
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <input type="text" name="comment" class="form-control @error('comment') is-invalid @enderror" value="{{ $comment = $commentData->useIdForData(session()->get('commentId'))[0]['sentence'] }}">
